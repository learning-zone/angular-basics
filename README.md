...
- [What are lifecycle hooks available?](#what-are-lifecycle-hooks-available-)
...
- [How to set time for caching in service-worker?](#how-to-set-time-for-caching-in-service-worker-)
...
- [What is the option to choose between inline and external template file?](#what-is-the-option-to-choose-between-inline-and-external-template-file-)
- [What is the purpose of ngFor directive?](#what-is-the-purpose-of-ngfor-directive-)
- [What is the purpose of ngIf directive?](#what-is-the-purpose-of-ngif-directive-)
- [What happens if you use script tag inside template?](#what-happens-if-you-use-script-tag-inside-template-)
- [What is interpolation?](#what-is-interpolation-)
- [What are template expressions?](#what-are-template-expressions-)
- [What are template statements?](#what-are-template-statements-)
...
- [How do you chain pipes?](#how-do-you-chain-pipes-)
- [What is a custom pipe?](#what-is-a-custom-pipe-)
- [Give an example of custom pipe?](#give-an-example-of-custom-pipe-)
...
- [What is HttpClient and its benefits?](#what-is-httpclient-and-its-benefits-)
- [Explain on how to use HttpClient with an example?](#explain-on-how-to-use-httpclient-with-an-example-)
- [How can you read full response?](#how-can-you-read-full-response-)
- [How do you perform Error handling?](#how-do-you-perform-error-handling-)
...
- [What are the utility functions provided by RxJS?](#what-are-the-utility-functions-provided-by-rxjs-)
- [What are observable creation functions?](#what-are-observable-creation-functions-)
- [What will happen if you do not supply handler for observer?](#what-will-happen-if-you-do-not-supply-handler-for-observer-)
- [What are angular elements?](#what-are-angular-elements-)
- [What is the browser support of Angular Elements?](#what-is-the-browser-support-of-angular-elements-)
- [What are custom elements?](#what-are-custom-elements-)
- [Do I need to bootstrap custom elements?](#do-i-need-to-bootstrap-custom-elements-)
- [Explain how custom elements works internally?](#explain-how-custom-elements-works-internally-)
- [How to transfer components to custom elements?](#how-to-transfer-components-to-custom-elements-)
- [What are the mapping rules between Angular component and custom element?](#what-are-the-mapping-rules-between-angular-component-and-custom-element-)
- [How do you define typings for custom elements?](#how-do-you-define-typings-for-custom-elements-)
...
- [What is Angular Router?](#what-is-angular-router-)
- [What is the purpose of base href tag?](#what-is-the-purpose-of-base-href-tag-)
- [What are the router imports?](#what-are-the-router-imports-)
- [What is router outlet?](#what-is-router-outlet-)
- [What are router links?](#what-are-router-links-)
- [What are active router links?](#what-are-active-router-links-)
- [What is router state?](#what-is-router-state-)
- [What are router events?](#what-are-router-events-)
...
- [Do I need a Routing Module always?](#do-i-need-a-routing-module-always-)
...
- [What are the advantages with AOT?](#what-are-the-advantages-with-aot-)
- [What are the ways to control AOT compilation?](#what-are-the-ways-to-control-aot-compilation-)
- [What are the restrictions of metadata?](#what-are-the-restrictions-of-metadata-)
- [What are the two phases of AOT?](#what-are-the-two-phases-of-aot-)
- [Can I use arrow functions in AOT?](#can-i-use-arrow-functions-in-aot-)
- [What is the purpose of metadata json files?](#what-is-the-purpose-of-metadata-json-files-)
- [Can I use any javascript feature for expression syntax in AOT?](#can-i-use-any-javascript-feature-for-expression-syntax-in-aot-)
- [What is folding?](#what-is-folding-)
- [What are macros?](#what-are-macros-)
- [Give an example of few metadata errors?](#give-an-example-of-few-metadata-errors-)
- [What is metadata rewriting?](#what-is-metadata-rewriting-)
- [How do you provide configuration inheritance?](#how-do-you-provide-configuration-inheritance-)
- [How do you specify angular template compiler options?](#how-do-you-specify-angular-template-compiler-options-)
- [How do you enable binding expression validation?](#how-do-you-enable-binding-expression-validation-)
- [What is the purpose of any type cast function?](#what-is-the-purpose-of-any-type-cast-function-)
- [What is Non null type assertion operator?](#what-is-non-null-type-assertion-operator-)
- [What is type narrowing?](#what-is-type-narrowing-)
- [How do you describe various dependencies in angular application?](#how-do-you-describe-various-dependencies-in-angular-application-)
- [What is zone?](#what-is-zone-)
- [What is the purpose of common module?](#what-is-the-purpose-of-common-module-)
- [What is codelyzer?](#what-is-codelyzer-)
- [What is angular animation?](#what-is-angular-animation-)
- [What are the steps to use animation module?](#what-are-the-steps-to-use-animation-module-)
- [What is State function?](#what-is-state-function-)
- [What is Style function?](#what-is-style-function-)
- [What is the purpose of animate function?](#what-is-the-purpose-of-animate-function-)
- [What is transition function?](#what-is-transition-function-)
- [How to inject the dynamic script in angular?](#how-to-inject-the-dynamic-script-in-angular-)
...
- [Can I use AOT compilation with Ivy?](#can-i-use-aot-compilation-with-ivy-)
- [What is Angular Language Service?](#what-is-angular-language-service-)
- [How do you install angular language service in the project?](#how-do-you-install-angular-language-service-in-the-project-)
- [Is there any editor support for Angular Language Service?](#is-there-any-editor-support-for-angular-language-service-)
- [Explain the features provided by Angular Language Service?](#explain-the-features-provided-by-angular-language-service-)
- [How do you add web workers in your application?](#how-do-you-add-web-workers-in-your-application-)
- [What are the limitations with web workers?](#what-are-the-limitations-with-web-workers-)
- [What is Angular CLI Builder?](#what-is-angular-cli-builder-)
- [What is a builder?](#what-is-a-builder-)
- [How do you invoke a builder?](#how-do-you-invoke-a-builder-)
- [How do you create app shell in Angular?](#how-do-you-create-app-shell-in-angular-)
- [What are the case types in Angular?](#what-are-the-case-types-in-angular-)
- [What are the class decorators in Angular?](#what-are-the-class-decorators-in-angular-)
- [What are class field decorators?](#what-are-class-field-decorators-)
- [What is declarable in Angular?](#what-is-declarable-in-angular-)
- [What are the restrictions on declarable classes?](#what-are-the-restrictions-on-declarable-classes-)
- [What is a DI token?](#what-is-a-di-token-)
- [What is Angular DSL?](#what-is-angular-dsl-)
- [What is Bazel tool?](#what-is-bazel-tool-)
- [What are the advantages of Bazel tool?](#what-are-the-advantages-of-bazel-tool-)
- [How do you use Bazel with Angular CLI?](#how-do-you-use-bazel-with-angular-cli-)
- [How do you run Bazel directly?](#how-do-you-run-bazel-directly-)
- [What is Angular Framework?](#what-is-angular-framework-)
- [What is angular CLI?](#what-is-angular-cli-)
- [What is Ng-Content/Content Projection?](#what-is-ng-content-content-projection-)
...
- [How routing works in Angular?](#how-routing-works-in-angular-)
- [Explain local reference variables, @ViewChild() and @ContentChild().](#explain-local-reference-variables---viewchild---and--contentchild--)
- [How to make sure that single instance will be used in an entire application?](#how-to-make-sure-that-single-instance-will-be-used-in-an-entire-application-)
- [How do you reference the host of a component?](#how-do-you-reference-the-host-of-a-component-)
- [Why would you use renderer methods instead of using native element methods? / What is difference between Renderer and ElementRef in angular?](#why-would-you-use-renderer-methods-instead-of-using-native-element-methods----what-is-difference-between-renderer-and-elementref-in-angular-)
...
- [How to cache an observable data?](#how-to-cache-an-observable-data-)
- [What do you understand by a template variable?](#what-do-you-understand-by-a-template-variable-)
- [What is shadow DOM? How is it helping Angular to perform better?](#what-is-shadow-dom--how-is-it-helping-angular-to-perform-better-)
- [How do you use a JavaScript third party lib in an Angular App?](#how-do-you-use-a-javascript-third-party-lib-in-an-angular-app-)
- [Can we create two Components with the same name in two different .ts files?](#can-we-create-two-components-with-the-same-name-in-two-different-ts-files-)
- [What's the difference between RouterModule.forRoot(ROUTES) and RouterModule.forChild(ROUTES)?](#what-s-the-difference-between-routermoduleforroot-routes--and-routermoduleforchild-routes--)
- [What are the difference between @Inject and @Injectable?](#what-are-the-difference-between--inject-and--injectable-)
- [What are Zones? What is Change Detection? What would be a good use for NgZone service?](#what-are-zones--what-is-change-detection--what-would-be-a-good-use-for-ngzone-service-)
- [What is auxiliary routes in angular?](#what-is-auxiliary-routes-in-angular-)
- [How do you get a reference to a child component?](#how-do-you-get-a-reference-to-a-child-component-)
- [How do you listen for events in a component?](#how-do-you-listen-for-events-in-a-component-)
- [How do you force a change detection cycle?](#how-do-you-force-a-change-detection-cycle-)
- [How would you get a reference to a parent component?](#how-would-you-get-a-reference-to-a-parent-component-)
- [What does forwardRef do?](#what-does-forwardref-do-)
- [What are entryComponents?](#what-are-entrycomponents-)
- [When building custom form components, what interface do they components need to implement to particpate in forms?](#when-building-custom-form-components--what-interface-do-they-components-need-to-implement-to-particpate-in-forms-)
- [What are the best way to unsubscribe from Observables in Angular?](#what-are-the-best-way-to-unsubscribe-from-observables-in-angular-)
- [How Event Emitters works in Angular?](#how-event-emitters-works-in-angular-)
- [How will you intercept http to inject header to each http call?](#how-will-you-intercept-http-to-inject-header-to-each-http-call-)
- [How will you parallelize multiple observable call?](#how-will-you-parallelize-multiple-observable-call-)
- [How will you put one async call before another?](#how-will-you-put-one-async-call-before-another-)
- [How can you cancel a router navigation?](#how-can-you-cancel-a-router-navigation-)
- [How would you animate routing?](#how-would-you-animate-routing-)
- [How would you make sure an api call that needs to be called only once but with multiple conditions?](#how-would-you-make-sure-an-api-call-that-needs-to-be-called-only-once-but-with-multiple-conditions-)
...
- [How can you access validation errors in the template to display error messages?](#how-can-you-access-validation-errors-in-the-template-to-display-error-messages-)
- [How do you unit test a service with a dependency?](#how-do-you-unit-test-a-service-with-a-dependency-)
- [What is the difference between an observable and a promise?](#what-is-the-difference-between-an-observable-and-a-promise-)
- [What is the difference between an observable and a subject?](#what-is-the-difference-between-an-observable-and-a-subject-)
- [What the importance of Dirty Flag, pristine, touched, untouched, valid, invalid?](#what-the-importance-of-dirty-flag--pristine--touched--untouched--valid--invalid-)
- [what is defer in promise?](#what-is-defer-in-promise-)
- [What is the difference between an Annotation and a Decorator in Angular?](#what-is-the-difference-between-an-annotation-and-a-decorator-in-angular-)
- [What is transclusion in angular?](#what-is-transclusion-in-angular-)
- [If your data model is updated outside the ‘Zone’, explain the process how will you the view?](#if-your-data-model-is-updated-outside-the--zone---explain-the-process-how-will-you-the-view-)
- [What is the process of inserting an embedded view from a prepared TemplateRef?](#what-is-the-process-of-inserting-an-embedded-view-from-a-prepared-templateref-)
