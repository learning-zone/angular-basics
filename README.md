...
- [Q. Angular Commands](#q-angular-commands)
- [Q. What is difference between Angular Dev Build(JIT compilation) and Prod Build(AOT compilation)?](#q-what-is-difference-between-angular-dev-build-jit-compilation--and-prod-build-aot-compilation--)
- [Q. How to optimize loading large data in angular?](#q-how-to-optimize-loading-large-data-in-angular-)
- [Q. How an Angular application gets started or loaded?](#q-how-an-angular-application-gets-started-or-loaded-)
- [Q. What is rxjs subject in Angular?](#q-what-is-rxjs-subject-in-angular-)
...
- [Q. What is difference between BehaviorSubject and Observable?](#q-what-is-difference-between-behaviorsubject-and-observable-)
- [Q. What is the difference between AngularJS and Angular?](#q-what-is-the-difference-between-angularjs-and-angular-)
- [Q. What are the key components of Angular?](#q-what-are-the-key-components-of-angular-)
- [Q. What are directives?](#q-what-are-directives-)
- [Q. What are components?](#q-what-are-components-)
- [Q. What are the differences between Component and Directive?](#q-what-are-the-differences-between-component-and-directive-)
- [Q. What is a template?](#q-what-is-a-template-)
- [Q. What is a module?](#q-what-is-a-module-)
- [Q. What are lifecycle hooks available?](#q-what-are-lifecycle-hooks-available-)
- [Q. What is a data binding?](#q-what-is-a-data-binding-)
- [Q. What is metadata?](#q-what-is-metadata-)
- [Q. What is a service worker and its role in Angular?](#q-what-is-a-service-worker-and-its-role-in-angular-)
- [Q. How to set time for caching in service-worker?](#q-how-to-set-time-for-caching-in-service-worker-)
- [Q. What is the difference between constructor() and ngOnInit()?](#q-what-is-the-difference-between-constructor---and-ngoninit---)
- [Q. What is a service?](#q-what-is-a-service-)
- [Q. What is dependency injection in Angular?](#q-what-is-dependency-injection-in-angular-)
- [Q. What is the purpose of async pipe?](#q-what-is-the-purpose-of-async-pipe-)
- [Q. What is the option to choose between inline and external template file?](#q-what-is-the-option-to-choose-between-inline-and-external-template-file-)
- [Q. What is the purpose of ngFor directive?](#q-what-is-the-purpose-of-ngfor-directive-)
- [Q. What is the purpose of ngIf directive?](#q-what-is-the-purpose-of-ngif-directive-)
- [Q. What happens if you use script tag inside template?](#q-what-happens-if-you-use-script-tag-inside-template-)
- [Q. What is interpolation?](#q-what-is-interpolation-)
- [Q. What are template expressions?](#q-what-are-template-expressions-)
- [Q. What are template statements?](#q-what-are-template-statements-)
- [Q. How do you categorize data binding types?](#q-how-do-you-categorize-data-binding-types-)
- [Q. What are pipes?](#q-what-are-pipes-)
- [Q. What is a parameterized pipe?](#q-what-is-a-parameterized-pipe-)
- [Q. How do you chain pipes?](#q-how-do-you-chain-pipes-)
- [Q. What is a custom pipe?](#q-what-is-a-custom-pipe-)
- [Q. Give an example of custom pipe?](#q-give-an-example-of-custom-pipe-)
- [Q. What is the difference between pure and impure pipe?](#q-what-is-the-difference-between-pure-and-impure-pipe-)
- [Q. What is a bootstrapping module?](#q-what-is-a-bootstrapping-module-)
- [Q. What are observables?](#q-what-are-observables-)
- [Q. What is HttpClient and its benefits?](#q-what-is-httpclient-and-its-benefits-)
- [Q. Explain on how to use HttpClient with an example?](#q-explain-on-how-to-use-httpclient-with-an-example-)
- [Q. How can you read full response?](#q-how-can-you-read-full-response-)
- [Q. How do you perform Error handling?](#q-how-do-you-perform-error-handling-)
- [Q. What is RxJS?](#q-what-is-rxjs-)
- [Q. What is subscribing?](#q-what-is-subscribing-)
- [Q. What is an observable?](#q-what-is-an-observable-)
- [Q. What is an observer?](#q-what-is-an-observer-)
- [Q. What is the difference between promise and observable?](#q-what-is-the-difference-between-promise-and-observable-)
- [Q. What is multicasting?](#q-what-is-multicasting-)
- [Q. How do you perform error handling in observables?](#q-how-do-you-perform-error-handling-in-observables-)
- [Q. What is the short hand notation for subscribe method?](#q-what-is-the-short-hand-notation-for-subscribe-method-)
- [Q. What are the utility functions provided by RxJS?](#q-what-are-the-utility-functions-provided-by-rxjs-)
- [Q. What are observable creation functions?](#q-what-are-observable-creation-functions-)
- [Q. What will happen if you do not supply handler for observer?](#q-what-will-happen-if-you-do-not-supply-handler-for-observer-)
- [Q. What are angular elements?](#q-what-are-angular-elements-)
- [Q. What is the browser support of Angular Elements?](#q-what-is-the-browser-support-of-angular-elements-)
- [Q. What are custom elements?](#q-what-are-custom-elements-)
- [Q. Do I need to bootstrap custom elements?](#q-do-i-need-to-bootstrap-custom-elements-)
- [Q. Explain how custom elements works internally?](#q-explain-how-custom-elements-works-internally-)
- [Q. How to transfer components to custom elements?](#q-how-to-transfer-components-to-custom-elements-)
- [Q. What are the mapping rules between Angular component and custom element?](#q-what-are-the-mapping-rules-between-angular-component-and-custom-element-)
- [Q. How do you define typings for custom elements?](#q-how-do-you-define-typings-for-custom-elements-)
- [Q. What are dynamic components?](#q-what-are-dynamic-components-)
- [Q. What are the various kinds of directives?](#q-what-are-the-various-kinds-of-directives-)
- [Q. How do you create directives using CLI?](#q-how-do-you-create-directives-using-cli-)
- [Q. Give an example for attribute directives?](#q-give-an-example-for-attribute-directives-)
- [Q. What is Angular Router?](#q-what-is-angular-router-)
- [Q. What is the purpose of base href tag?](#q-what-is-the-purpose-of-base-href-tag-)
- [Q. What are the router imports?](#q-what-are-the-router-imports-)
- [Q. What is router outlet?](#q-what-is-router-outlet-)
- [Q. What are router links?](#q-what-are-router-links-)
- [Q. What are active router links?](#q-what-are-active-router-links-)
- [Q. What is router state?](#q-what-is-router-state-)
- [Q. What are router events?](#q-what-are-router-events-)
- [Q. What is activated route?](#q-what-is-activated-route-)
- [Q. How do you define routes?](#q-how-do-you-define-routes-)
- [Q. What is the purpose of Wildcard route?](#q-what-is-the-purpose-of-wildcard-route-)
- [Q. Do I need a Routing Module always?](#q-do-i-need-a-routing-module-always-)
- [Q. What is Angular Universal?](#q-what-is-angular-universal-)
- [Q. What are different types of compilation in Angular?](#q-what-are-different-types-of-compilation-in-angular-)
- [Q. What is JIT?](#q-what-is-jit-)
- [Q. What is AOT?](#q-what-is-aot-)
- [Q. Why do we need compilation process?](#q-why-do-we-need-compilation-process-)
- [Q. What are the advantages with AOT?](#q-what-are-the-advantages-with-aot-)
- [Q. What are the ways to control AOT compilation?](#q-what-are-the-ways-to-control-aot-compilation-)
- [Q. What are the restrictions of metadata?](#q-what-are-the-restrictions-of-metadata-)
- [Q. What are the two phases of AOT?](#q-what-are-the-two-phases-of-aot-)
- [Q. Can I use arrow functions in AOT?](#q-can-i-use-arrow-functions-in-aot-)
- [Q. What is the purpose of metadata json files?](#q-what-is-the-purpose-of-metadata-json-files-)
- [Q. Can I use any javascript feature for expression syntax in AOT?](#q-can-i-use-any-javascript-feature-for-expression-syntax-in-aot-)
- [Q. What is folding?](#q-what-is-folding-)
- [Q. What are macros?](#q-what-are-macros-)
- [Q. Give an example of few metadata errors?](#q-give-an-example-of-few-metadata-errors-)
- [Q. What is metadata rewriting?](#q-what-is-metadata-rewriting-)
- [Q. How do you provide configuration inheritance?](#q-how-do-you-provide-configuration-inheritance-)
- [Q. How do you specify angular template compiler options?](#q-how-do-you-specify-angular-template-compiler-options-)
- [Q. How do you enable binding expression validation?](#q-how-do-you-enable-binding-expression-validation-)
- [Q. What is the purpose of any type cast function?](#q-what-is-the-purpose-of-any-type-cast-function-)
- [Q. What is Non null type assertion operator?](#q-what-is-non-null-type-assertion-operator-)
- [Q. What is type narrowing?](#q-what-is-type-narrowing-)
- [Q. How do you describe various dependencies in angular application?](#q-how-do-you-describe-various-dependencies-in-angular-application-)
- [Q. What is zone?](#q-what-is-zone-)
- [Q. What is the purpose of common module?](#q-what-is-the-purpose-of-common-module-)
- [Q. What is codelyzer?](#q-what-is-codelyzer-)
- [Q. What is angular animation?](#q-what-is-angular-animation-)
- [Q. What are the steps to use animation module?](#q-what-are-the-steps-to-use-animation-module-)
- [Q. What is State function?](#q-what-is-state-function-)
- [Q. What is Style function?](#q-what-is-style-function-)
- [Q. What is the purpose of animate function?](#q-what-is-the-purpose-of-animate-function-)
- [Q. What is transition function?](#q-what-is-transition-function-)
- [Q. How to inject the dynamic script in angular?](#q-how-to-inject-the-dynamic-script-in-angular-)
- [Q. What is Angular Ivy?](#q-what-is-angular-ivy-)
- [Q. What are the features included in ivy preview?](#q-what-are-the-features-included-in-ivy-preview-)
- [Q. Can I use AOT compilation with Ivy?](#q-can-i-use-aot-compilation-with-ivy-)
- [Q. What is Angular Language Service?](#q-what-is-angular-language-service-)
- [Q. How do you install angular language service in the project?](#q-how-do-you-install-angular-language-service-in-the-project-)
- [Q. Is there any editor support for Angular Language Service?](#q-is-there-any-editor-support-for-angular-language-service-)
- [Q. Explain the features provided by Angular Language Service?](#q-explain-the-features-provided-by-angular-language-service-)
- [Q. How do you add web workers in your application?](#q-how-do-you-add-web-workers-in-your-application-)
- [Q. What are the limitations with web workers?](#q-what-are-the-limitations-with-web-workers-)
- [Q. What is Angular CLI Builder?](#q-what-is-angular-cli-builder-)
- [Q. What is a builder?](#q-what-is-a-builder-)
- [Q. How do you invoke a builder?](#q-how-do-you-invoke-a-builder-)
- [Q. How do you create app shell in Angular?](#q-how-do-you-create-app-shell-in-angular-)
- [Q. What are the case types in Angular?](#q-what-are-the-case-types-in-angular-)
- [Q. What are the class decorators in Angular?](#q-what-are-the-class-decorators-in-angular-)
- [Q. What are class field decorators?](#q-what-are-class-field-decorators-)
- [Q. What is declarable in Angular?](#q-what-is-declarable-in-angular-)
- [Q. What are the restrictions on declarable classes?](#q-what-are-the-restrictions-on-declarable-classes-)
- [Q. What is a DI token?](#q-what-is-a-di-token-)
- [Q. What is Angular DSL?](#q-what-is-angular-dsl-)
- [Q. What is Bazel tool?](#q-what-is-bazel-tool-)
- [Q. What are the advantages of Bazel tool?](#q-what-are-the-advantages-of-bazel-tool-)
- [Q. How do you use Bazel with Angular CLI?](#q-how-do-you-use-bazel-with-angular-cli-)
- [Q. How do you run Bazel directly?](#q-how-do-you-run-bazel-directly-)
- [Q. What is Angular Framework?](#q-what-is-angular-framework-)
- [Q. What is angular CLI?](#q-what-is-angular-cli-)
- [Q. What is Ng-Content/Content Projection?](#q-what-is-ng-content-content-projection-)
- [Q. How can I select an element in a component template?](#q-how-can-i-select-an-element-in-a-component-template-)
- [Q. What is Redux and how does it relate to an Angular app?](#q-what-is-redux-and-how-does-it-relate-to-an-angular-app-)
- [Q. How routing works in Angular?](#q-how-routing-works-in-angular-)
- [Q. Explain local reference variables, @ViewChild() and @ContentChild().](#q-explain-local-reference-variables---viewchild---and--contentchild--)
- [Q. How to make sure that single instance will be used in an entire application?](#q-how-to-make-sure-that-single-instance-will-be-used-in-an-entire-application-)
- [Q. How do you reference the host of a component?](#q-how-do-you-reference-the-host-of-a-component-)
- [Q. Why would you use renderer methods instead of using native element methods? / What is difference between Renderer and ElementRef in angular?](#q-why-would-you-use-renderer-methods-instead-of-using-native-element-methods----what-is-difference-between-renderer-and-elementref-in-angular-)
- [Q. How would you control size of an element on resize of the window in a component?](#q-how-would-you-control-size-of-an-element-on-resize-of-the-window-in-a-component-)
- [Q. How to cache an observable data?](#q-how-to-cache-an-observable-data-)
- [Q. What do you understand by a template variable?](#q-what-do-you-understand-by-a-template-variable-)
- [Q. What is shadow DOM? How is it helping Angular to perform better?](#q-what-is-shadow-dom--how-is-it-helping-angular-to-perform-better-)
- [Q. How do you use a JavaScript third party lib in an Angular App?](#q-how-do-you-use-a-javascript-third-party-lib-in-an-angular-app-)
- [Q. Can we create two Components with the same name in two different .ts files?](#q-can-we-create-two-components-with-the-same-name-in-two-different-ts-files-)
- [Q. What's the difference between RouterModule.forRoot(ROUTES) and RouterModule.forChild(ROUTES)?](#q-what-s-the-difference-between-routermoduleforroot-routes--and-routermoduleforchild-routes--)
- [Q. What are the difference between @Inject and @Injectable?](#q-what-are-the-difference-between--inject-and--injectable-)
- [Q. What are Zones? What is Change Detection? What would be a good use for NgZone service?](#q-what-are-zones--what-is-change-detection--what-would-be-a-good-use-for-ngzone-service-)
- [Q. What is auxiliary routes in angular?](#q-what-is-auxiliary-routes-in-angular-)
- [Q. How do you get a reference to a child component?](#q-how-do-you-get-a-reference-to-a-child-component-)
- [Q. How do you listen for events in a component?](#q-how-do-you-listen-for-events-in-a-component-)
- [Q. How do you force a change detection cycle?](#q-how-do-you-force-a-change-detection-cycle-)
- [Q. How would you get a reference to a parent component?](#q-how-would-you-get-a-reference-to-a-parent-component-)
- [Q. What does forwardRef do?](#q-what-does-forwardref-do-)
- [Q. What are entryComponents?](#q-what-are-entrycomponents-)
- [Q. When building custom form components, what interface do they components need to implement to particpate in forms?](#q-when-building-custom-form-components--what-interface-do-they-components-need-to-implement-to-particpate-in-forms-)
- [Q. What are the best way to unsubscribe from Observables in Angular?](#q-what-are-the-best-way-to-unsubscribe-from-observables-in-angular-)
- [Q. How Event Emitters works in Angular?](#q-how-event-emitters-works-in-angular-)
- [Q. How will you intercept http to inject header to each http call?](#q-how-will-you-intercept-http-to-inject-header-to-each-http-call-)
- [Q. How will you parallelize multiple observable call?](#q-how-will-you-parallelize-multiple-observable-call-)
- [Q. How will you put one async call before another?](#q-how-will-you-put-one-async-call-before-another-)
- [Q. How can you cancel a router navigation?](#q-how-can-you-cancel-a-router-navigation-)
- [Q. How would you animate routing?](#q-how-would-you-animate-routing-)
- [Q. How would you make sure an api call that needs to be called only once but with multiple conditions?](#q-how-would-you-make-sure-an-api-call-that-needs-to-be-called-only-once-but-with-multiple-conditions-)
- [Q. If you need to respond to two different Observable/Subject with one callback function, how would you do it? (ex: if you need to change the url through route parameters and with prev/next buttons).](#q-if-you-need-to-respond-to-two-different-observable-subject-with-one-callback-function--how-would-you-do-it---ex--if-you-need-to-change-the-url-through-route-parameters-and-with-prev-next-buttons-)
- [Q. How can you access validation errors in the template to display error messages?](#q-how-can-you-access-validation-errors-in-the-template-to-display-error-messages-)
- [Q. How do you unit test a service with a dependency?](#q-how-do-you-unit-test-a-service-with-a-dependency-)
- [Q. What is the difference between an observable and a promise?](#q-what-is-the-difference-between-an-observable-and-a-promise-)
- [Q. What is the difference between an observable and a subject?](#q-what-is-the-difference-between-an-observable-and-a-subject-)
- [Q. What the importance of Dirty Flag, pristine, touched, untouched, valid, invalid?](#q-what-the-importance-of-dirty-flag--pristine--touched--untouched--valid--invalid-)
- [Q. what is defer in promise?](#q-what-is-defer-in-promise-)
- [Q. What is the difference between an Annotation and a Decorator in Angular?](#q-what-is-the-difference-between-an-annotation-and-a-decorator-in-angular-)
- [Q. What is transclusion in angular?](#q-what-is-transclusion-in-angular-)
- [Q. If your data model is updated outside the ‘Zone’, explain the process how will you the view?](#q-if-your-data-model-is-updated-outside-the--zone---explain-the-process-how-will-you-the-view-)
- [Q. What is the process of inserting an embedded view from a prepared TemplateRef?](#q-what-is-the-process-of-inserting-an-embedded-view-from-a-prepared-templateref-)
